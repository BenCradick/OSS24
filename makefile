...
$(OSS_EXECUTABLE): $(OSS_OBJ) $(PCB_OBJ) $(CLOCK_OBJ) $(MESSAGE_OBJ)
	$(CXX) $(CFLAGS) -o $@ $^ -lrt -std=c++17


$(USER_EXECUTABLE): $(USER_OBJ)
	$(CC) $(CFLAGS) -o $@ $^ -lrt -std=c++17
...
%.o: %.cpp $(USER_HEADERS) $(PCB_HEADERS) $(CONSTANTS_HEADERS) $(CLOCK_HEADERS) $(WORKER_HEADERS) $(MESSAGE_HEADERS)
	$(CXX) $(CFLAGS) -c -o $@ $<

.PHONY: clean
clean:
	rm -f $(OSS_OBJ) $(USER_OBJ) $(OSS_EXECUTABLE) $(USER_EXECUTABLE) $(WORKER_OBJ) $(WORKER_EXECUTABLE) $(PCB_OBJ) $(CLOCK_OBJ) $(MESSAGE_OBJ)
